...
class Game:
    ...
    def import_asset(self):
        ...
        self.star_animation_frames = import_folder(
            Path.joinpath(
                Path(__file__).parents[1], "graphics", "other", "star animation"
            )
        )

        self.audio = audio_importer(Path.joinpath(Path(__file__).parents[1], "audio"))
    ...
    def end_dialog(self, character):
        ...
        if character.nurse:
            ...
            self.transition_target = Battle(
                ...
                monster_frame=self.monster_frames,
