    ...
    def import_assets(self):
        ...
        self.fonts = {
            "dialog": pygame.font.Font(
                join("..", "graphics", "fonts", "PixeloidSans.ttf"), 30
            ),
            "regular": pygame.font.Font(
                join("..", "graphics", "fonts", "PixeloidSans.ttf"), 18
            ),
            "small": pygame.font.Font(
                join("..", "graphics", "fonts", "PixeloidSans.ttf"), 14
            ),
            "bold": pygame.font.Font(
                join("..", "graphics", "fonts", "dogicapixelbold.otf"), 20
            ),
        }
    ...
    def monster_encounter(self):
        ...
        if sprites and self.player.direction:
            ...
            self.transition_target = Battle(
                player_monsters=self.player_monsters,
                opponent_monsters={
                    index: Monster(monster, sprites[0].level + randint(-3, 3))
                    for index, monster in enumerate(sprites[0].monsters)
                },
                monster_frames=self.monster_frames,
